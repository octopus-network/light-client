...
impl TryFrom<Any> for AnyClientMessage {
    ...
    fn try_from(value: Any) -> Result<Self, Self::Error> {
        match value.type_url.as_str() {
            MOCK_CLIENT_MESSAGE_TYPE_URL => Ok(Self::Mock(panic!(
                "MockClientMessage doesn't implement Protobuf"
            ))),
            ...
            _ => Err(ics02_client::error::Error::unknown_consensus_state_type(
                value.type_url,
            )),
        }
    }
